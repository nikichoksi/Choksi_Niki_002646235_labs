...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if(row<0){
            JOptionPane.showMessageDialog(null,"Please select a product from the table to be viewed", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int row = tblProducts.getSelectedRow();
        if(row<0){
            JOptionPane.showMessageDialog(null,"Please select a row from table to be deleted", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        Product selectedProduct = (Product) tblProducts.getValueAt(row, 0);
