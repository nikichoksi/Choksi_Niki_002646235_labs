...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblProductCatalog.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        ...
        tblCart.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (salesPrice < product.getPrice()) {
            JOptionPane.showMessageDialog(this, "Price should be more than it is set in the Price Field.");
            return;
        }
